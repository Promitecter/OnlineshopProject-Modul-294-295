...
export default function CategoryForm({ initialCategory = null, onSubmit }) {
    const isEdit = Boolean(initialCategory); /* Dieser Boolean zeigt an, ob wir eine Kategorie bearbeiten, oder eine neue Kategorie anlegen. */
    ...
    e.preventDefault();
    if (!name.trim()) { /* Überprüfung auf leeren Kategorienamen, beispielsweise mit einem Leerschlag. */
